...
4. 自定义注解 @LoginRequired 注解，可以自动装配当前操作人的实体。该注解的意义在于，消除在每个 controller 方法需要手动获取当前操作人的重复性的代码。
...
5. 自研 Excel 报表导入导出工具。 配合自定义查询语法，可高效开发报表导出功能。详细参照方法：BaseUserController.exportByExcel 。
