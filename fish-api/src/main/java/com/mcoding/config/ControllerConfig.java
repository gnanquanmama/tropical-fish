...
import com.mcoding.exception.CommonException;
import com.mcoding.util.ResponseCode;
...
public class ControllerConfig {
    ...
    public ResponseResult<String> exceptionHandler(HttpServletRequest request, HttpServletResponse response,
        ...
        String errorMessage = allErrors.stream().findFirst().map(error -> error.getDefaultMessage()).get();
